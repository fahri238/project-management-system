...
const UserManagement = () => {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: 'Budi Santoso', email: 'budi@sagara.ai', role: 'supervisor', status: 'Active' },
    { id: 2, name: 'Siti Aminah', email: 'siti@sagara.ai', role: 'staff', status: 'Active' },
    { id: 3, name: 'Andi Pratama', email: 'andi@sagara.ai', role: 'staff', status: 'Inactive' },
    { id: 4, name: 'Diana Putri', email: 'diana@sagara.ai', role: 'supervisor', status: 'Active' },
    { id: 5, name: 'Eko Wijaya', email: 'eko@sagara.ai', role: 'staff', status: 'Active' },
  ]);
